...
import { performCheckin, fetchPegawaiFromAPI, sendWhatsAppNotification, sendTelegramNotification } from './checkin.js';
...
const config = {
    ...
    enableScreenshot: process.env.ENABLE_SCREENSHOT === 'true',
};
